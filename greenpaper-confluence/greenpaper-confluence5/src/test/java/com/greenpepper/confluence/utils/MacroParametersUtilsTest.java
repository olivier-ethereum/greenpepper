...
public class MacroParametersUtilsTest extends TestCase {

	public void testReturnsEmptyIfNoParameterExist() {
		Map<String, String> parameters = Maps.newHashMap();
		
		assertEquals("should return empty string if parameter not set", "", MacroParametersUtils.extractParameter("NonExistingParamName", parameters));
		assertEquals("should return empty array if parameter not set", 0, MacroParametersUtils.extractParameterMultiple("NonExistingParamName", parameters).length);
	}
