...
import com.greenpepper.interpreter.flow.scenario.AccountAlreadyExistException;
import com.greenpepper.interpreter.flow.scenario.Bank;
import com.greenpepper.interpreter.flow.scenario.BankFixture;
import com.greenpepper.interpreter.flow.scenario.Expectation;
import com.greenpepper.interpreter.flow.scenario.Money;
import com.greenpepper.interpreter.flow.scenario.Owner;
...
public class ScenarioInterpreterTest
{
    ...
    public void checkDispatchCallForCheckScenario() throws Exception
    {
        ...
        Tables tables = tables(
                "I cannot withdraw $125 of account ABC123",
                "I cannot withdraw $2 of account ABC123" /*wrong*/,
                "I can withdraw $25 of account ABC123",
    ...
    {
        Tables tables = tables(
                "I have a checking account ABC123 under the name of Bart Simpson",
                "The balance of account ABC123 is $10",
                "The balance of account ABC123 is $0",
                "A method not associated to an @",
                "I deposit $100 in account ABC123",
                "The balance of account ABC123 is $100",
                "I cannot withdraw $125 of account ABC123",
                "I can withdraw $25 of account ABC123",
                "I withdraw $999 of account ABC123 (ex)",
                "Show the balance of account ABC123" );
