...
public class BankFixture
{
    ...
    {
        if (mock != null) mock.openCheckingAccount( account, owner );
    ...
    {
        if (mock != null) mock.createCheckingAccount( account, owner );
    ...
    {
        if (mock != null) mock.theBalanceOfAccount( account, balance );
    ...
    public void theBalanceOfAccount(String account, Expectation balance, Expectation balancePlusOne) throws NoSuchAccountException
    {

        if (mock != null) mock.theBalanceOfAccount( account, balance, balancePlusOne );
    ...
    public boolean withdraw(Money amount, String account) throws Exception
    {
        ...
        if (mock != null) mock.withdraw( amount, account );
        //return false;
    ...
    public boolean cannotWithdraw(Money amount, String account) throws Exception
    {
        ...
        if (mock != null) mock.cannotWithdraw( amount, account );
    ...
    {
        if (mock != null) mock.canWithdraw( amount, account );
        bank.withdraw( amount, account, WithdrawType.ATM );
        return true;
    }
    ...
    public Money getBalanceOfAccount(String account) throws NoSuchAccountException
    {
        ...
        if (mock != null) mock.getBalanceOfAccount( account );
