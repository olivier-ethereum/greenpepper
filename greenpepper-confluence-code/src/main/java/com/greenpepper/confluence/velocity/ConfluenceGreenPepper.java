...
public class ConfluenceGreenPepper
{
	...
	{
		return ConfluencePlugin.VERSION;
	}

	public String getVersionDate()
	{
		DateFormat df = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT);
		return df.format(ConfluencePlugin.versionDate());
	}
    ...
    {
        return getWikiStyleRenderer().convertWikiToXHtml(page.toPageContext(), page.getContent());
    }
