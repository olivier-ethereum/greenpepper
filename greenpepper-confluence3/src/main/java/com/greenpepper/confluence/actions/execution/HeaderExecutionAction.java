...
{   
    ...
    public String getRenderedContent()
    {
    	...
    	try 
    	{
    		content = implemented ? gpUtil.getImplementedContent(getPage()) : getPage().getContent();
    	}
    	catch(GreenPepperServerException e)
    	{
    		content = "";
    	...
    	return gpUtil.getWikiStyleRenderer().convertWikiToXHtml(getPage().toPageContext(), content);
    }
