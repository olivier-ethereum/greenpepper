...
public class OgnlExpectation implements Expectation
{
    ...
    public static OgnlExpectation create( String expected )
    {
        ...
        if (!OgnlExpectation.conditionalExpression( expected ) &&
            !OgnlExpectation.extractExpression( expected )) return null;
    ...
    private void assertValidExpression( String matchee )
    {
        if (!conditionalExpression( matchee ) && !extractExpression( matchee ))
