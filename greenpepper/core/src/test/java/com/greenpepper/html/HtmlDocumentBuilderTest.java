...
public class HtmlDocumentBuilderTest extends TestCase {
    ...
    public void testThatWeCanInjectTheCssInBody() throws Exception {
        ...
        assertEquals("<body ng-controller><style type=\"text/css\">" + css + "</style><h1 name=\"title\" content=\"a title\"/></body>", stream.toString());
    ...
    public void testThatWeCanInjectTheCssInBodyprecededwithTag() throws Exception {
        ...
        assertEquals("<html><body><style type=\"text/css\">" + css + "</style><h1 name=\"title\" content=\"a title\"/></body>", stream.toString());
