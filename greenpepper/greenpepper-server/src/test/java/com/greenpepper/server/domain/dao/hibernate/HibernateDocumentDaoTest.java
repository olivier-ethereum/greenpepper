...
public class HibernateDocumentDaoTest extends AbstractDBUnitHibernateMemoryTest {
    ...
    public void testTheCRUDOfASpecification() throws GreenPepperServerException {
        ...
        /*
         * Creating A Specification Without Specifying A Sut And No Default Sut Is Defined Will
         * Throw AnException
         */
        try {
            session.getTransaction().begin();
    ...
    public void testTheBehaviorOfASpecificationAndTheSystemUnderTest() throws GreenPepperServerException {
        ...
        /*
         * An Error Occures If We Try To Deassociate A Sut From A Specification If Both Are In The
         * Same Reference
         */
        systemUnderTest = SystemUnderTest.newInstance("SUT-REFERENCED");
        systemUnderTest.setProject(Project.newInstance("PROJECT-1"));
    ...
    public void testWeCanRetrieveTheSpecificationListByNamesForASUT() {
        Project project = Project.newInstance("PROJECT-1");
        SystemUnderTest sut = SystemUnderTest.newInstance("SUT-1");
        sut.setProject(project);
        Repository repository = Repository.newInstance("UID-1");
        ...
        List<String> specificationNames = new ArrayList<String>() {
        ...
        List<Specification> specifications = documentDao.getSpecificationsByName(repository.getUid(), specificationNames);

        assertEquals(3, specifications.size());
        for (Specification specification : specifications) {
            assertEquals("SUT-1", specification.getTargetedSystemUnderTests().first().getName());
        }
    }
